...
vars:
    ...
    account_history_end_date: 'YYYY-MM-DD' # The first date in account history you wish to pull records from, filtering on `_fivetran_end`.
    ...
    contact_history_end_date: 'YYYY-MM-DD' # The first date in contact history you wish to pull records from, filtering on `_fivetran_end`.
