...
The main focus of this package is enable users to better understand the performance of their opportunities. You can easily understand what is going on in your sales funnel, and also dig into how the members of your sales team are performing. 
...
salesforce\_sales\_snapshot|A single row snapshot providing various metrics about your sales funnel.
...
* For users who have multiple sets of Salesforce data in their warehouse, a package defining sources doesn't make sense. They will have to define their own sources and union that data together. At that point, they will still be able to make use of this package to transform their data.
