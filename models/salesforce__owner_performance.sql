...
select 
    ...
    case 
        when (bookings_amount_closed_this_month + lost_amount_this_month) > 0 then
    ...
    case 
        when (bookings_amount_closed_this_quarter + lost_amount_this_quarter) > 0 then
    ...
    case 
        when (total_bookings_amount + total_lost_amount) > 0 then 
